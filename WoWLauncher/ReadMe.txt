========================================================================
   APLICACIÓN: WoWLauncher Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación WoWLauncher.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación WoWLauncher.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado WoWLauncher.pch y un archivo de tipos 
